/*
	Keypress observe monitors a document's keypresses and if they match the specified combo it calls the callback.
...
*/
Keypress.observe = Class.create();
Object.extend(Keypress.observe.prototype,
{
