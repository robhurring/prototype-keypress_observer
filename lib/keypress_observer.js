...
Object.extend(Keypress.Observer.prototype,
{
  initialize: function(key_code, callback, options) {
	...
	/* HACK:  this is horribly hacky, but i'm not sure how else to adjust for the CTRL offset
						between browsers. FF uses 0, IE and SAFARI use 64/96 -- except IE doesn't use this
						when checking for keys outside the ANSI range... so "?" would want -16.
						
						maybe someone can shed some light on this? or i need to universally convert to a univ.
						encoding?
	*/
